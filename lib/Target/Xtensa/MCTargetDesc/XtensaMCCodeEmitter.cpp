//===-- Xtensa/XtensaMCCodeEmitter.cpp - Convert Xtensa code to machine code -------===//
//
...
unsigned XtensaMCCodeEmitter::getMachineOpValue(const MCInst &MI,
  ...
  case MCSymbolRefExpr::VK_Xtensa_LO: {
    FixupKind = Xtensa::fixup_leg_mov_lo16_pcrel;
    break;
  }
  case MCSymbolRefExpr::VK_Xtensa_HI: {
    FixupKind = Xtensa::fixup_leg_mov_hi16_pcrel;
    break;
  }
  }
  */
...
unsigned XtensaMCCodeEmitter::getMemSrcValue(const MCInst &MI, unsigned OpIdx,
                                          SmallVectorImpl<MCFixup> &Fixups,
                                          const MCSubtargetInfo &STI) const {
  unsigned Bits = 0;
